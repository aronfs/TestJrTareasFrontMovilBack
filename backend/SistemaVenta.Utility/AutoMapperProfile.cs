    ...
    public class AutoMapperProfile: Profile
    {
        public AutoMapperProfile()
        {
         ...
         //     .ForMember(dest => dest.Foto, opt => opt.MapFrom(src => src.Foto)); // Se agregó el campo Foto
            ...
            #region Tareas
            CreateMap<Tareas, TareaDTO>().ReverseMap();
            CreateMap<Tareas, TareaListarDTO>().ReverseMap();
               //.ForMember(dest => dest.Estado_Tarea, opt => opt.MapFrom(src => src.Estado_Tarea == false ? false : true));
            #endregion
