...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Tareas>(entity =>
        {
            ...
            entity.Property(e => e.IdTarea).HasColumnName("idtareas");
            entity.Property(e => e.Titulo_Tarea).HasColumnName("titulo_tarea");
            entity.Property(e => e.Descripcion).HasColumnName("descripcion");
            entity.Property(e => e.Comentario).HasColumnName("comentario");
            entity.Property(e => e.IdUsuario).HasColumnName("idusuario");
            entity.Property(e => e.Estado_Tarea).HasColumnName("estadotarea");
